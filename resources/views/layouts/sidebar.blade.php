    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="{{ Request::is('user*') ? 'active' : '' }}">
                <a href="/user" class="">
                    <i class="fa-light fa-calendar-days"></i> <span>Users</span>
                    <span class="pull-right-container">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i> Transaksi Jurnal</a></li>
                    <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i> Transaksi Penyesuaian</a></li>
                </ul>
            </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href=""><i class="fa fa-circle-o"></i>Laba Rugi</a></li>
                    <li><a href=""><i class="fa fa-circle-o"></i>Perubahan</a></li>
                    <li><a href=""><i class="fa fa-circle-o"></i>Neraca</a></li>
